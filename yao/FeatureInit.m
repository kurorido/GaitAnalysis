...
Deriv_Pelvis_X = deriv(Acceleration_Pelvis_X);
Deriv_Pelvis_Y = deriv(Acceleration_Pelvis_Y);
Deriv_Pelvis_Z = deriv(Acceleration_Pelvis_Z);

Deriv2_Pelvis_X = deriv2(Acceleration_Pelvis_X);
Deriv2_Pelvis_Y = deriv2(Acceleration_Pelvis_Y);
Deriv2_Pelvis_Z = deriv2(Acceleration_Pelvis_Z);

Deriv4_Pelvis_X = deriv4(Acceleration_Pelvis_X);
Deriv4_Pelvis_Y = deriv4(Acceleration_Pelvis_Y);
Deriv4_Pelvis_Z = deriv4(Acceleration_Pelvis_Z);
...
Deriv_RightUpperLeg_X = deriv(Acceleration_RightUpperLeg_X);
Deriv_RightUpperLeg_Y = deriv(Acceleration_RightUpperLeg_Y);
Deriv_RightUpperLeg_Z = deriv(Acceleration_RightUpperLeg_Z);

Deriv2_RightUpperLeg_X = deriv2(Acceleration_RightUpperLeg_X);
Deriv2_RightUpperLeg_Y = deriv2(Acceleration_RightUpperLeg_Y);
Deriv2_RightUpperLeg_Z = deriv2(Acceleration_RightUpperLeg_Z);

Deriv4_RightUpperLeg_X = deriv4(Acceleration_RightUpperLeg_X);
Deriv4_RightUpperLeg_Y = deriv4(Acceleration_RightUpperLeg_Y);
Deriv4_RightUpperLeg_Z = deriv4(Acceleration_RightUpperLeg_Z);	
...
Deriv_LeftUpperLeg_X = deriv(Acceleration_LeftUpperLeg_X);
Deriv_LeftUpperLeg_Y = deriv(Acceleration_LeftUpperLeg_Y);
Deriv_LeftUpperLeg_Z = deriv(Acceleration_LeftUpperLeg_Z);

Deriv2_LeftUpperLeg_X = deriv2(Acceleration_LeftUpperLeg_X);
Deriv2_LeftUpperLeg_Y = deriv2(Acceleration_LeftUpperLeg_Y);
Deriv2_LeftUpperLeg_Z = deriv2(Acceleration_LeftUpperLeg_Z);

Deriv4_LeftUpperLeg_X = deriv4(Acceleration_LeftUpperLeg_X);
Deriv4_LeftUpperLeg_Y = deriv4(Acceleration_LeftUpperLeg_Y);
Deriv4_LeftUpperLeg_Z = deriv4(Acceleration_LeftUpperLeg_Z);			
...
Deriv_RightLowerLeg_X = deriv(Acceleration_RightLowerLeg_X);
Deriv_RightLowerLeg_Y = deriv(Acceleration_RightLowerLeg_Y);
Deriv_RightLowerLeg_Z = deriv(Acceleration_RightLowerLeg_Z);

Deriv2_RightLowerLeg_X = deriv2(Acceleration_RightLowerLeg_X);
Deriv2_RightLowerLeg_Y = deriv2(Acceleration_RightLowerLeg_Y);
Deriv2_RightLowerLeg_Z = deriv2(Acceleration_RightLowerLeg_Z);

Deriv4_RightLowerLeg_X = deriv4(Acceleration_RightLowerLeg_X);
Deriv4_RightLowerLeg_Y = deriv4(Acceleration_RightLowerLeg_Y);
Deriv4_RightLowerLeg_Z = deriv4(Acceleration_RightLowerLeg_Z);
...
Deriv_LeftLowerLeg_X = deriv(Acceleration_LeftLowerLeg_X);
Deriv_LeftLowerLeg_Y = deriv(Acceleration_LeftLowerLeg_Y);
Deriv_LeftLowerLeg_Z = deriv(Acceleration_LeftLowerLeg_Z);

Deriv2_LeftLowerLeg_X = deriv2(Acceleration_LeftLowerLeg_X);
Deriv2_LeftLowerLeg_Y = deriv2(Acceleration_LeftLowerLeg_Y);
Deriv2_LeftLowerLeg_Z = deriv2(Acceleration_LeftLowerLeg_Z);

Deriv4_LeftLowerLeg_X = deriv4(Acceleration_LeftLowerLeg_X);
Deriv4_LeftLowerLeg_Y = deriv4(Acceleration_LeftLowerLeg_Y);
Deriv4_LeftLowerLeg_Z = deriv4(Acceleration_LeftLowerLeg_Z);
...
Deriv_RightFoot_X = deriv(Acceleration_RightFoot_X);
Deriv_RightFoot_Y = deriv(Acceleration_RightFoot_Y);
Deriv_RightFoot_Z = deriv(Acceleration_RightFoot_Z);

Deriv2_RightFoot_X = deriv2(Acceleration_RightFoot_X);
Deriv2_RightFoot_Y = deriv2(Acceleration_RightFoot_Y);
Deriv2_RightFoot_Z = deriv2(Acceleration_RightFoot_Z);

Deriv4_RightFoot_X = deriv4(Acceleration_RightFoot_X);
Deriv4_RightFoot_Y = deriv4(Acceleration_RightFoot_Y);
Deriv4_RightFoot_Z = deriv4(Acceleration_RightFoot_Z);
...
Deriv_LeftFoot_X = deriv(Acceleration_LeftFoot_X);
Deriv_LeftFoot_Y = deriv(Acceleration_LeftFoot_Y);
Deriv_LeftFoot_Z = deriv(Acceleration_LeftFoot_Z);

Deriv2_LeftFoot_X = deriv2(Acceleration_LeftFoot_X);
Deriv2_LeftFoot_Y = deriv2(Acceleration_LeftFoot_Y);
Deriv2_LeftFoot_Z = deriv2(Acceleration_LeftFoot_Z);

Deriv4_LeftFoot_X = deriv4(Acceleration_LeftFoot_X);
Deriv4_LeftFoot_Y = deriv4(Acceleration_LeftFoot_Y);
Deriv4_LeftFoot_Z = deriv4(Acceleration_LeftFoot_Z);
